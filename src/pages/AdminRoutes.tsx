...
type Row = { _id?: string; identity?: string; wallet?: string; username?: string; name?: string; daoId?: string; title?: string; status?: string; banned?: boolean; type?: string; actorLabel?: string; targetLabel?: string; createdAt?: string; kind?: string; error?: string; message?: string; proposalId?: string; grantId?: string };
